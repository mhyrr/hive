...
|------|---------|-------------------|--------------|
| 2026-05-11 | Maya (CAMP-006) | CC 2.1.138, Codex 0.128.0 | alwaysLoad gap (TK-002), codex_hooks deprecation (TK-003), plugin packaging opportunity (TK-004), model pin bump planning (TK-001, P3). Iter 3 corrected model retirement claim — Opus 4.6 is Active until Feb 2027, not retiring June 15. |
