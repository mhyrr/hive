...
model: opus
tools: Read, Glob, Grep, Bash, mcp__hive__read_hive_memory, mcp__hive__search_taste, mcp__hive__convene_council, mcp__hive__list_tickets, mcp__hive__show_ticket, mcp__hive__create_ticket, mcp__hive__write_hive_memory
maxTurns: 30
---
