...
- HIVE-001 | Dogfood baseline audit | done | owner: alpha | deps: none
  Deliverable: completed in `20260310-020408Z-alpha-to-orchestrator-0862a50b.md`.
- HIVE-002 | Convert baseline into prioritized fixes | done | owner: orchestrator | deps: HIVE-001
  Deliverable: baseline findings absorbed into the board; next implementation
  task queued.
- HIVE-008 | Fix front-door summary correctness | active | owner: orchestrator | deps: HIVE-007
...
## Agents
- orchestrator | active | task: HIVE-008 front-door summary correctness | last-active: 2026-03-10T23:12:00Z
